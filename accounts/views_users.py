...
def users_list_or_create_view(request):
    """
    GET /api/users/ — list with filtering, pagination, ordering.
    POST /api/users/ — create user.
    Single view: no calling other views (avoids AssertionError).
    """
    ...
    # POST — create user (inline, do not call another view)
